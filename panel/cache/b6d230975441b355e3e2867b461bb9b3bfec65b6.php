...
<div class="container body">
    ...
    <div class="main_container">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.php" class="site_title"> <span><span>Panel <small style="font-size: 10px;">by ITBox</small></span></span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a target="_new" href="http://itbox.bg"><i class="fa fa-laptop"></i> Website </a></li>
                            <li><a target="_new" href="https://github.com/slaserx/itbox/issues"><i class="fa fa-exclamation-triangle"></i> Report </a></li>
        ...
        <div class="right_col" role="main">
            ...
            <footer>
                <div class="">
                    <p class="pull-right">Panel by <a href="http://www.itbox.bg" target="_new">ITBox</a>
