...
<div class="row">
 ...
 <div class="widget_summary">
                    ...
                    <div class="w_center w_55">
                        <div class="progress">
                            <div class="progress-bar bg-aero" role="progressbar" aria-valuenow="{{ $cpu['pr'] }}" aria-valuemin="0" aria-valuemax="100" style="width: 45%;">
                ...
                <div class="widget_summary">
                    ...
                    <div class="w_center w_55">
                        <div class="progress">
                            <div class="progress-bar bg-aero" role="progressbar" aria-valuenow="{{ $mem['pr'] }}"  aria-valuemin="0" aria-valuemax="100" style="width: 5%;">
                            </div>
                        </div>
                    </div>
                    <div class="w_right w_20">
                        <span>{{ $mem['count'] }} / {{ $mem['total'] }} GB</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="widget_summary">
                    ...
                    <div class="w_center w_55">
                        <div class="progress">
                            <div class="progress-bar bg-aero" role="progressbar" aria-valuenow="{{ $space['pr'] }}" aria-valuemin="0" aria-valuemax="100" style="width: 66%;">
